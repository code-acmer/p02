-ifndef(PBACTIVITY_PB_H).
-define(PBACTIVITY_PB_H, true).
-record(pbactivity, {
    id,
    activity_desc,
    category,
...
-ifndef(PBACTIVITYLIST_PB_H).
-define(PBACTIVITYLIST_PB_H, true).
-record(pbactivitylist, {
    activity = [],
    mails_count
}).
-endif.
...
-ifndef(PBTWISTEGG_PB_H).
-define(PBTWISTEGG_PB_H, true).
-record(pbtwistegg, {
    type,
    count,
    add_att_flag,
...
-ifndef(PBTWISTEGGLIST_PB_H).
-define(PBTWISTEGGLIST_PB_H, true).
-record(pbtwistegglist, {
    twist_egg = []
}).
-endif.
